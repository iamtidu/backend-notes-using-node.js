...
o	Updating Packages: You can update packages to their latest versions.
	npm update
o	Uninstalling Packages: You can remove packages from your project.
	npm uninstall express
o	Global Packages: You can install packages globally to use them across multiple projects.
	npm install -g nodemon
o	Development Dependencies: Some packages are only needed during development. You can install these as development dependencies.
...
o	Non-blocking and do not wait for the operation to complete.
o	Use callbacks or promises to handle the result of the operation.
o	Preferred for I/O-bound tasks to keep the application responsive.
 Example:
	const fs = require('fs');
...
o	Blocking and wait for the operation to complete before moving to the next line of code.
o	Simplify code structure since they do not require callbacks or promises.
o	Not recommended for I/O-bound tasks in a production environment due to potential performance issues.
 Example:
	const fs = require('fs');
